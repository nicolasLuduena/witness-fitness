...
export const witnesses = {
  ...
  adminSecretKey: ({ privateState }: WitnessBase): [PrivateState, Uint8Array] => [
    privateState,
    privateState.adminSecretKey,
  ],

  getHolderSecret: ({ privateState }: WitnessBase): [PrivateState, Uint8Array] => [
    privateState,
  ...
  getAttestationWitness: ({
    ...
    return [
      privateState,
      [privateState.assertion, privateState.signatures, privateState.commitRand],
    ];
  },

  getSubmissionRand: ({ privateState }: WitnessBase): [PrivateState, Uint8Array] => [
    privateState,
