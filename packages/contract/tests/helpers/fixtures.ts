...
export const holderBindingOf = (secret: Uint8Array): bigint => pureCircuits.holderBinding(secret);
...
export const privateStateWith = (base: PrivateState, att: SignedAttestation): PrivateState => ({
  ...base,
