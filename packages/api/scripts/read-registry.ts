...
const address = process.env.CONTRACT_ADDRESS ?? 'cf80ad421b2b85f6ca1b3c0ccfd140ae5f6fc0d5871426d7750df4d42944cbaf';
...
console.log('wagers:', ledgerState.wagers.isEmpty() ? '[]' : [...ledgerState.wagers].map(([id]) => id));
process.exit(0);
