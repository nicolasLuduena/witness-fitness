              ...
              t.preventDefault(),
                (function () {
                  if (l) {
                    ...
                    "" === t
                      ? (s && s.remove(), (o = null))
                      : ((s = new f("slidecontent")), (o = s.apply(t)), (i = 0));
                  }
                  o &&
    ...
    function f(t, n) {
      ...
      (this.setRegex = function (e) {
          ...
          if (null != t && t && d && !l.test(t.nodeName)) {
            ...
            if (3 == t.nodeType)
              if ((o = t.nodeValue) && (f = d.exec(o))) {
                ...
                y || c.push(p),
                  r[f[0].toLowerCase()] || (r[f[0].toLowerCase()] = s[a++ % s.length]);
        ...
        (this.apply = function (e) {
          if (null != e && e) return this.remove(), this.setRegex(e), this.hiliteWords(o), c;
        });
    }
    return {
      id: "search",
