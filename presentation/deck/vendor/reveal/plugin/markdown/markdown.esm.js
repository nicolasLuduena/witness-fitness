    ...
    if (t) {
      ...
      for (; e && ((g = !1), (t = x.exec(e))) && !this.rules.block.hr.test(e); ) {
        ...
        k.loose || (a ? (k.loose = !0) : /\n *\n *$/.test(n) && (a = !0)),
          ...
          k.items.push({ type: "list_item", raw: n, task: !!s, checked: r, loose: !1, text: u }),
          (k.raw += n);
      }
    ...
    if (n) {
      ...
      return (
        "@" === n[2]
          ...
          : ((e = a(n[1])), (s = e)),
        { type: "link", raw: n[0], text: e, href: s, tokens: [{ type: "text", raw: e, text: e }] }
      );
    }
  }
  url(e, t) {
...
class v {
  constructor(e) {
    ...
    this.options.pedantic
      ...
      : this.options.gfm &&
        ((n.block = R.gfm), this.options.breaks ? (n.inline = T.breaks) : (n.inline = T.gfm)),
    ...
    for (n = 0; n < $; n++)
      if (
        ...
        switch (u.type) {
          ...
          case "list":
            for (
              g = u.ordered, d = u.start, f = u.loose, i = u.items.length, p = "", s = 0;
              s < i;
              s++
            )
              (x = u.items[s]),
      ...
      if (null !== t && void 0 !== t.childNodes && t.childNodes.length > 0) {
        ...
        for (let i = 0; i < t.childNodes.length; i++) {
          ...
          "section" === l.nodeName && ((o = l), (n = l)),
            ("function" != typeof l.setAttribute && l.nodeType !== Node.COMMENT_NODE) ||
              a(o, l, n, s, r);
        }
      }
